...
mod serialization_tests {
    ...
    fn test_operation_interpolate() {
        ...
        let c2 = Operation::Interpolate(
            Some(Coordinates::at_y(-2, CoordinateFormat::new(ZeroOmission::Leading, CoordinateMode::Absolute, 4, 4))),
            None,
        );
    ...
    fn test_operation_move() {
        let c = Operation::Move(Some(Coordinates::new(23, 42, CoordinateFormat::new(ZeroOmission::Leading, CoordinateMode::Absolute, 6, 4))));
        assert_code!(c, "X230000Y420000D02*\n");
    }

    #[test]
    fn test_operation_flash() {
        let c = Operation::Flash(Some(Coordinates::new(23, 42, CoordinateFormat::new(ZeroOmission::Leading, CoordinateMode::Absolute, 4, 4))));
    ...
    fn test_coordinate_format_tz() {
        let c = ExtendedCode::CoordinateFormat(CoordinateFormat::new(ZeroOmission::Leading, CoordinateMode::Absolute, 2, 5));
        assert_code!(c, "%FSLAX25Y25*%\n");
    }

    #[test]
    fn test_coordinate_format_lz() {
        let c = ExtendedCode::CoordinateFormat(CoordinateFormat::new(ZeroOmission::Trailing, CoordinateMode::Incremental, 2, 5));
